                        ...
                        <tr>
                           <th><i class="require-red">*</i>下单时间:</th>
                            ...
                            <tr>
                                <th></th>
                                <td>
                                    <input class="btn btn-primary btn6 mr10" value="修改" type="button" onclick="UpdateIndent(<%=id%>)">
...
function UpdateIndent(ID){
	...
	if(Count != ""){
		$.post("/NewEnterpriseProject/DoIndentUpdate", {"id":ID,"mid":Mid,"pid":Pid,"count":Count,"date":Date},function(rst){
			if(rst == "success"){
				alert("修改成功");
				window.location.href= "/NewEnterpriseProject/partII/IndentUpdate.jsp?id="+ID;
			}

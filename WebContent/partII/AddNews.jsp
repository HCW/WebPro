...
function PostData(Img)
{
	...
	//	alert(button);
		...
		if(Content != ""){
			$.post("/NewEnterpriseProject/DoNewsInsert", {"title":Title,"author":Author,"img":Img,"content":Content},function(rst){
				if(rst == "success"){
					alert("添加成功");
					window.location.href= "/NewEnterpriseProject/partII/AddNews.jsp";
				}
				else{
					alert("添加失败");
				}
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name"><a href="NewaManager.jsp">新闻管理</a></span><span class="crumb-step">&gt;</span><span class="crumb-name">添加新闻</span></div>
        </div>

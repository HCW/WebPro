...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name"><a href="productmanager.jsp">产品管理</a></span><span class="crumb-step">&gt;</span><span class="crumb-name">添加产品</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="pid" name="title" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>产品名称：</th>
                                <td>
                                    <input class="common-text required" id="name" name="author" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>产品价格：</th>
                                <td>
                                    <input class="common-text required" id="price" name="author" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>数量：</th>
                                <td>
                                    <input class="common-text required" id="count" name="author" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>产品描述：</th>
                                <td><textarea name="content" class="common-textarea" id="dec" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
                                    <input class="btn btn-primary btn6 mr10" value="添加" type="button" onclick="InsertProduct()">
...
function InsertProduct(){
	...
	var Dec=$("#dec").val();
	if(Pid != ""){
		$.post("/NewEnterpriseProject/DoProductInsert", {"pid":Pid,"name":Name,"price":Price,"count":Count,"dec":Dec},function(rst){
			if(rst == "success"){
				alert("添加成功");
				window.location.href= "/NewEnterpriseProject/partII/AddProduct.jsp";
			}
			else{
				alert("添加失败");
			}

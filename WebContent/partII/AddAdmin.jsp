...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name"><a href="adminmanager.jsp">管理员管理</a></span><span class="crumb-step">&gt;</span><span class="crumb-name">添加管理员</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="aid" name="title" size="50" value="" type="text" >
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th></th>
                                <td>
                                    <input class="btn btn-primary btn6 mr10" value="添加" type="button" onclick="InsertAdmin()">
...
function InsertAdmin(){
	...
	if(Aid != ""){
		//alert("修改成功");
		$.post("/NewEnterpriseProject/DoAdminAdd", {"aid":Aid,"name":Name,"pwd":Pwd,"per":Per},function(rst){
			if(rst == "success"){
				alert("添加成功");
				window.location.href= "/NewEnterpriseProject/partII/AddAdmin.jsp";
			}
			else{
				alert("添加失败");
			}

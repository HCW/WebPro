...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">会员管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="AddMember.jsp"><i class="icon-font"></i>添加会员</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        while(it.hasNext())
                        {
                        	...
                        	out.println("<td>"+newsl.getPwd()+"</td>");
                        	out.println("<td>");
                        	out.println("<a class='link-update' href='MemberUpdate.jsp?id="+newsl.getID()+"'>修改</a>");
                        	out.println("<a class='link-update' onclick='DelMeb("+newsl.getID()+")'>删除</a>");
                        	out.println("<a class='link-update' href='MemberView.jsp?id="+newsl.getID()+"'>详情</a>");
                        	out.println("</td>");
                        	out.println("</tr>");
                        	Count++;
                        }
...
function DelMeb(ID)
{
	if (confirm("你确定要删除该会员吗？")) {  
		$.post("/NewEnterpriseProject/DoMemberDel",{"mid":ID},function(rst){
			if(rst == "success"){
				alert("删除成功！");
				window.location.href= "/NewEnterpriseProject/partII/memberManager.jsp";
			}
			else{
				alert("删除失败！");
			}

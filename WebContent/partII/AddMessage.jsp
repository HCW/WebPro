...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name"><a href="messageManager.jsp">留言管理</a></span><span class="crumb-step">&gt;</span><span class="crumb-name">添加留言</span></div>
        </div>
            ...
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th width="120"><i class="require-red">*</i>留言者:</th>
                            <td>
                            ...
                            <tr>
                                <th></th>
                                <td>
                                    <input class="btn btn-primary btn6 mr10" value="添加" type="button" onclick="InsertMsg()">
...
function InsertMsg(){
	...
	if(Content != ""){
		$.post("/NewEnterpriseProject/DoMessageInsert", {"content":Content,"mid":mid,"date":date},function(rst){
			if(rst == "success"){
				alert("添加成功");
				window.location.href= "/NewEnterpriseProject/partII/AddMessage.jsp";
			}
			else{
				alert("添加失败");
			}

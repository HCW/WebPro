                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
					...
					%>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="name" name="author" size="50" value="<%=message.getName()%>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>产品价格：</th>
                                <td>
                                    <input class="common-text required" id="price" name="author" size="50" value="<%=message.getPrice() %>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>数量：</th>
                                <td>
                                    <input class="common-text required" id="count" name="author" size="50" value="<%=message.getCount() %>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>产品描述：</th>
                                <td><textarea name="content" class="common-textarea" id="dec" cols="30" style="width: 98%;" rows="10"><%=message.getDec() %></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>

                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
					...
					%>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="name" name="author" size="50" value="<%=user.getName()%>" type="text" readonly="true">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>密码：</th>
                                <td>
                                    <input class="common-text required" id="pwd" name="author" size="50" value="<%=user.getPwd()%>" type="text" readonly="true">
                                </td>
                            </tr>
                            <tr>
                                <th width="120"><i class="require-red">*</i>权限：</th>
                            <td>
                                <select name="colId" id="per" class="required" readonly="true">

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,com.tool.News" import="java.util.*,com.tool.mbUser" errorPage="../error.jsp"%>
...
<div class="pro_list clearfix">
  ...
  <div class="pro_m">
        ...
        <div class="pro_md">
            ...
            <div class="time">
            	<span>来源：<%=message.getAuthor() %></span>
                <span>更新编号：<%=message.getId() %></span>
            </div>
            <div class="ctn">
            	<p><%=message.getContent() %></p>
            	<img  style="clear: both; display: block; margin:auto;" alt="" src="<%=message.getImg()%>"  width="300px" height="300px"  >
            </div>
            <div class="space_hx">&nbsp;</div>
            <!--导向页-->
            <div class="page_dx">

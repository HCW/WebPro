<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,com.tool.mbUser,com.tool.Message,com.tool.SelectSQL" %>
        	...
        	<div class="book_m">
            	...
            	<% SelectSQL sql=new SelectSQL();
                        ...
                        while(it.hasNext())
                        {
                        	...
                        	//out.println("<tr>");        	
                        	Count++;
                        	out.println("<li class='wen clearfix'>"); 
                        	out.println("<div class='w_left'>");
                    		out.println("<span>"+message.getName()+"先生"+"</span>"); 
                    		
                            out.println("留言：");
                        	out.println("</div>");
                        	
                        	out.println("<div class='w_ctn'>");
                        	out.println(message.getContent());
                        	out.println("</div>");
                            out.println("<div class='w_ctn'>"+message.getDate()+"</div>");	

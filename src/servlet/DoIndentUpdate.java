...
/**
 * Servlet implementation class DoIndentUpdate
 */
@WebServlet("/DoIndentUpdate")
public class DoIndentUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoIndentUpdate() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		while(iter.hasNext())
		{
			...
			else
			{
				...
				if(sql.UpdateIndent(ID,Mid, Pid, SumPrice, Count, Date))
				{
